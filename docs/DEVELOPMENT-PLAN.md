...
| **No way in** | Nobody models a whole system before seeing value. | `traceos init` scaffolds from an existing repo, and `coverage_declared: partial` is documented as the normal state, not a defect. |
